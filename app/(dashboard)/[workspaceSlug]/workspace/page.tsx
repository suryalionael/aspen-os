...
export default async function WorkspacePage(props: {
  ...
  try {
    ...
    let connection: { id: string; google_email: string } | null = null
    try {
      ...
      // Connection table not available yet — show connect prompt
    }
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  An error occurred while loading the workspace Drive.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
